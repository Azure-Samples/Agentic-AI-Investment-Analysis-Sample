...
from app.database.repositories import WorkflowEventRepository
from app.models import WorkflowEvent
from app.database.cosmos import CosmosDBClient
from app.workflow.event_queue import EventMessage


logger = logging.getLogger("app.services.workflow_events_service")
...
class WorkflowEventsService:
    ...
    def __init__(self, cosmos_client: CosmosDBClient):
        ...
        self.workflow_event_repo = WorkflowEventRepository(cosmos_client)
        
        # In-memory cache for events during workflow execution
        self._event_cache: Dict[str, List[EventMessage]] = {}
    ...
    def get_cached_events(self, analysis_id: str) -> List[EventMessage]:
    ...
    async def persist_cached_events(
        ...
        try:
            ...
            # Convert EventMessage objects to WorkflowEvent models
            workflow_events = []
