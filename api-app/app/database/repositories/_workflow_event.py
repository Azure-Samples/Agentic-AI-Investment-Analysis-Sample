...
class WorkflowEventRepository(BaseRepository):
    """Repository for WorkflowEvent operations"""
    ...
    async def get_events_by_analysis(
        ...
        return [WorkflowEvent(**event) for event in events_data]
    ...
    async def create_event(self, event: WorkflowEvent) -> WorkflowEvent:
        ...
        return WorkflowEvent(**_created)
    
    async def create_events_batch(self, events: List[WorkflowEvent]) -> List[WorkflowEvent]:
